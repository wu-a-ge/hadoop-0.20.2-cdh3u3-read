...
public abstract class ResourceCalculatorPlugin extends Configured
{
	...
	/**
	 * Obtain the total size of the available virtual memory present in the
	 * system.
	 * 
	...
	/**
	 * Obtain the total size of the available physical memory present in the
	 * system.
	 * 
	...
	public static class ProcResourceValues
	{
		...
		public ProcResourceValues(long cumulativeCpuTime,
				long physicalMemorySize, long virtualMemorySize)
		{
