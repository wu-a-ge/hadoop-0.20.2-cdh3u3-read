...
public class MD5MD5CRC32FileChecksum extends FileChecksum
{
	...
	public MD5MD5CRC32FileChecksum(int bytesPerCRC, long crcPerBlock,
			MD5Hash md5)
	{
			...
			throws SAXException
	{
		...
		{
			throw new SAXException("Invalid attributes: bytesPerCRC="
					+ bytesPerCRC + ", crcPerBlock=" + crcPerBlock + ", md5="
					+ md5, e);
		}
	}
