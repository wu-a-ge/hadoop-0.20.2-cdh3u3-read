...
public interface DataTransferProtocol
{
	 ...
	 */
	/*
	 * Version 16: Datanode now needs to send back a status code together with
	 * firstBadLink during pipeline setup for dfs write (only for DFSClients,
	...
	public static class PipelineAck
	{
		...
		final public static PipelineAck HEART_BEAT = new PipelineAck(
				HEARTBEAT_SEQNO, new short[0]);
