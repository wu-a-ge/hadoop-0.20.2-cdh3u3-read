...
public abstract class Storage extends StorageInfo
{
	...
	private class DirIterator implements Iterator<StorageDirectory>
	{
		...
		public boolean hasNext()
		{
			...
			if (dirType != null)
			{
				...
				{
					if (getStorageDir(nextIndex).getStorageDirType().isOfType(
							dirType))
						break;
					nextIndex++;
				}
	...
	public class StorageDirectory
	{
		 ...
		 * @throws IOException
		 */
		public StorageState analyzeStorage(StartupOption startOpt)
				throws IOException
		{
			...
			{ // check that storage exists
				if (!root.exists())
				{
					...
					{
						LOG.info("Storage directory " + rootPath
								+ " does not exist.");
	...
	public abstract boolean isConversionNeeded(StorageDirectory sd)
			throws IOException;
