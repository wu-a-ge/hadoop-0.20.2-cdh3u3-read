...
public class NameNode implements ClientProtocol, DatanodeProtocol,
		...
		RefreshUserMappingsProtocol, GetUserMappingsProtocol
{
	static
	{
	...
	private void initialize(Configuration conf) throws IOException
	{
		...
		pluginDispatcher = PluginDispatcher.createFromConfiguration(conf,
				DFSConfigKeys.DFS_NAMENODE_PLUGINS_KEY, NamenodePlugin.class);
   ...
   */
			...
			throws IOException
	{
		...
		if (files != null)
		{
			myMetrics.numFilesInGetListingOps
					.inc(files.getPartialListing().length);
		}
		return files;
	}
   ...
   */
			...
			int xceiverCount, int failedVolumes) throws IOException
	{
		...
		return namesystem.handleHeartbeat(nodeReg, capacity, dfsUsed,
				remaining, xceiverCount, xmitsInProgress, failedVolumes);
	}
	...
	public void refreshServiceAcl() throws IOException
	{
		...
		this.server.refreshServiceAcl(new Configuration(),
