 ...
 * 
 * Unlike {@link FileSplit}, CombineFileSplit class does not represent a split
 * of a file, but a split of input files into smaller sets. A split may contain
 * blocks from different file but all the blocks in the same split are probably
 * local to some rack <br>
 * CombineFileSplit can be used to implement {@link RecordReader}'s, with
...
public class CombineFileSplit extends InputSplit implements Writable
{
	...
	{
		this(old.getPaths(), old.getStartOffsets(), old.getLengths(), old
				.getLocations());
	}
