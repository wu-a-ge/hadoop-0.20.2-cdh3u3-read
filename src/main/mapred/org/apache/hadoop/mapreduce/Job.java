...
/**
 * The job submitter's view of the Job. It allows the user to configure the job,
 * submit it, control its execution, and query the state. The set methods only
 * work until the job is submitted, afterwards they will throw an
...
public class Job extends JobContext
{
	 ...
	 * 
	 * @param value
	 *            pass true if user's classes should take precedence
	 */
	...
	/**
	 * Get the <i>progress</i> of the job's setup, as a float between 0.0 and
	 * 1.0. When the job setup is completed, the function returns 1.0.
	 * 
