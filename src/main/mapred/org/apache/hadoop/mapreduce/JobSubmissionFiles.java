 ...
 * <b><i>Note that this class is for framework internal usage only and is not to
 * be used by users directly.</i></b>
 */
public class JobSubmissionFiles
{
	...
	final public static FsPermission JOB_DIR_PERMISSION = FsPermission
			.createImmutable((short) 0700); // rwx--------
	// job files are world-wide readable and owner writable
	final public static FsPermission JOB_FILE_PERMISSION = FsPermission
