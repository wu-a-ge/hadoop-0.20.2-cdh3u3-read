...
class ResourceEstimator
{
	...
	private static final Log LOG = LogFactory
			.getLog("org.apache.hadoop.mapred.ResourceEstimator");
	 ...
	 * 
	 * @param numMaps
	 *            the number of maps after which reduce starts launching. It
	 *            acts as the upper bound for the threshhold, so that we can get
	 *            right estimates before we reach these number of maps.
	 */
