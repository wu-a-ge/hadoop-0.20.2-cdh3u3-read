...
public class ClusterStatus implements Writable
{
	 ...
	 * @param maxMaps
	 *            the maximum no. of map tasks in the cluster
	 * @param maxReduces
	 *            the maximum no. of reduce tasks in the cluster
	 * @param state
	...
	{
		this(trackers, 0, JobTracker.TASKTRACKER_EXPIRY_INTERVAL, maps,
				reduces, maxMaps, maxReduces, state);
	}
	 ...
	 *            no. of tasktrackers in the cluster
	 * @param blacklists
	 *            no of blacklisted task trackers in the cluster
	 * @param ttExpiryInterval
	 *            the tasktracker expiry interval
	 * @param maps
	 *            no. of currently running map-tasks in the cluster
	 * @param reduces
	 *            no. of currently running reduce-tasks in the cluster
	 ...
	 * @param state
	 *            the {@link JobTracker.State} of the <code>JobTracker</code>
	 * @param numDecommissionedNodes
	 *            number of decommission trackers
	 */
	ClusterStatus(int trackers, int blacklists, long ttExpiryInterval,
			int maps, int reduces, int maxMaps, int maxReduces,
	...
	{
		this(trackers, blacklists, ttExpiryInterval, maps, reduces, maxMaps,
				maxReduces, state, numDecommissionedNodes,
	 ...
	 * Construct a new cluster status.
	 * 
	 * @param activeTrackers
	 *            active tasktrackers in the cluster
	 * @param blacklistedTrackers
	 *            blacklisted tasktrackers in the cluster
	 * @param ttExpiryInterval
	 *            the tasktracker expiry interval
	 * @param maps
	 *            no. of currently running map-tasks in the cluster
	...
	ClusterStatus(Collection<String> activeTrackers,
			...
			JobTracker.State state)
	{
		this(activeTrackers, blacklistedTrackers, ttExpiryInterval, maps,
				reduces, maxMaps, maxReduces, state, 0);
	}
			...
			JobTracker.State state, int numDecommissionNodes)
	{
		this(activeTrackers.size(), blacklistedTrackers.size(),
				...
				numDecommissionNodes, Runtime.getRuntime().totalMemory(),
