...
public interface AdminOperationsProtocol extends VersionedProtocol
{
	...
	/**
	 * Version 1: Initial version. Added refreshQueueAcls. Version 2: Added node
	 * refresh facility Version 3: Changed refreshQueueAcls to refreshQueues
	 */
	public static final long versionID = 3L;

	/**
	 * Refresh the queue acls in use currently. Refresh the queues used by the
	 * jobtracker and scheduler.
	 * 
