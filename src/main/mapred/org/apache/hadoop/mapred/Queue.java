...
class Queue
{
	...
	/**
	 * An Object that can be used by schedulers to fill in arbitrary scheduling
	 * information. The toString method of these objects will be called by the
	 * framework to get a String that can be displayed on UI.
	 */
	 ...
	 * 
	 * The keys in the map indicate the operations that can be performed, and
	 * the values indicate the list of users/groups who can perform the
	 * operation.
	 * 
	 * @return Map containing the operations that can be performed and who can
	 ...
	 * 
	 * @param acls
	 *            Map containing the operations that can be performed and who
	 ...
	 *            scheduling information for the queue.
	 */
