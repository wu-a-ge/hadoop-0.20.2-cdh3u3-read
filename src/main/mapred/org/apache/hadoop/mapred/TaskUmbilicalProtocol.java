...
public interface TaskUmbilicalProtocol extends VersionedProtocol
{
	 ...
	 * for HADOOP-4759 Version 16 Added fatalError for child to communicate
	 * fatal errors to TT Added numRequiredSlots to TaskStatus for MAPREDUCE-516
	 * Version 17 Change in signature of getTask() for HADOOP-5488 Version 18
	 * Added jvmContext to most method signatures for MAPREDUCE-2429
	 * */
	 ...
	 * @return True if the task is known
	 */
	boolean ping(TaskAttemptID taskid, JvmContext jvmContext)
			throws IOException;
	 ...
	 * @throws IOException
	 */
	boolean canCommit(TaskAttemptID taskid, JvmContext jvmContext)
			throws IOException;
	...
	/**
	 * The job initializer needs to report the sizes of the archive objects in
	 * the private distributed cache.
	 * 
	 * @param jobId
	 *            the job to update
	 * @param sizes
	 ...
	 * @throws IOException
	 */
	void updatePrivateDistributedCacheSizes(
