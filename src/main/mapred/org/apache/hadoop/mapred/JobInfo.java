...
/**
 * Represents the basic information that is saved per a job when the JobTracker
 * receives a submitJob request. The information is saved so that the JobTracker
 * can recover incomplete jobs upon restart.
 */
class JobInfo implements Writable
{
	...
	public JobInfo(org.apache.hadoop.mapreduce.JobID id, Text user,
			Path jobSubmitDir)
	{
		this.id = id;
		this.user = user;
