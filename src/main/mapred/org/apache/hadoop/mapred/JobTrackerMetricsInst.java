		...
		Updater
{
	...
	public void doUpdates(MetricsContext unused)
	{
		synchronized (this)
		{
			...
			metricsRecord
					.incrMetric("blacklisted_maps", numBlackListedMapSlots);
			...
			metricsRecord
					.incrMetric("reduces_launched", numReduceTasksLaunched);
			metricsRecord.incrMetric("reduces_completed",
			...
			metricsRecord.incrMetric("reserved_reduce_slots",
					numReservedReduceSlots);
			metricsRecord.incrMetric("occupied_map_slots", numOccupiedMapSlots);
			metricsRecord.incrMetric("occupied_reduce_slots",
					numOccupiedReduceSlots);
			...
			metricsRecord.incrMetric("trackers_blacklisted",
					numTrackersBlackListed);
