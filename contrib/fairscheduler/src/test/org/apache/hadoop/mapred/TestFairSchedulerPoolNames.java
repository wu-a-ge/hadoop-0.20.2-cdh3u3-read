...
public class TestFairSchedulerPoolNames
{
	...
	public void setUp() throws Exception
	{
		...
		miniMRCluster = new MiniMRCluster(1, namenode, 1, null, null,
				clusterConf);
	}
	...
	private void submitJob(String pool) throws IOException
	{
		...
		conf.set("mapred.job.tracker",
				"localhost:" + miniMRCluster.getJobTrackerPort());
	...
	/**
	 * Tests job submission using a valid pool name (i.e., name exists in the
